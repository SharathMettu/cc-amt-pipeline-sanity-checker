...
Then share the URL with your team (e.g., http://localhost:8501)
...
# ============================================================
st.set_page_config(
    page_title="CC_AMT_PIPELINE Sanity Checker",
    page_icon="✅",
    layout="wide"
)
...
def generate_report(filename, all_errors, all_warnings, all_passes):
    ...
    lines = []
    lines.append("=" * 60)
    lines.append("CC_AMT_PIPELINE SANITY CHECK REPORT")
    lines.append("=" * 60)
...
# Header
st.title("🔍 CC_AMT_PIPELINE Sanity Checker v2.1")
